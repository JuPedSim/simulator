...
void bind_special_area(pybind11::module_ & m)
{
    pybind11::class_<jps::SpecialArea>(m, "SpecialArea")
        ...
        .def_property_readonly("external_id", &jps::SpecialArea::getExternalID, pybind11::return_value_policy::copy)
        .def_property_readonly("id", &jps::SpecialArea::getID, pybind11::return_value_policy::copy)
        .def_property_readonly("area", &jps::SpecialArea::getArea, pybind11::return_value_policy::copy)
        .def(
            "__str__",
